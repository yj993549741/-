		...
		var cityJson = [
			...
			$(function(){
			    ...
			    $.each(cityJson, function(index,areaValue) {
			        ...
			        if(suffix == '0000'){
			            strBufferObj.append("<option id='pro' value=\'" + areaValue.item_code + "\'>" + areaValue.item_name + "</option>");
			        }
			    });
			...
			function doProvAndCityRelation(){
			    ...
			    $.each(cityJson, function(index, areaValue){
			        if(areaValue.item_code.substr(0, 2) == province.substr(0, 2) && areaValue.item_code.substr(2, 4) != '0000' && areaValue.item_code.substr(4, 2) == '00'){
			            strBufferObj.append("<option id='city' value=\'" + areaValue.item_code + "\'>" + areaValue.item_name + "</option>");
			        }
			    });
			    ...
			    $.each(cityJson, function(index, areaValue){
			        ...
			        if(city == '110100' || city == '120100' || city == '310100' || city == '500100'){
			            if(areaValue.item_code.substr(0, 3) == city.substr(0, 3) && areaValue.item_code.substr(4, 2) !== '00'){
			                strBufferObj.append("<option id='cou' value=\'" + areaValue.item_code + "\'>" + areaValue.item_name + "</option>");
			            }
			        }else{
		...
		<script type="text/javascript">
			$(document).ready(function(){
				$("#addr").focus(function(){
					...
					var citys = document.getElementById("citys").innerHTML;
					var county = document.getElementById("county").innerHTML;
					$("#addr").val(province+citys+county);
				});
			});
		</script>
	</head>
	<%-- <body>
		<form method="post" action="<%=request.getServletContext().getContextPath()%>/user/insert.do">
		<div class="regist">
			<div class="regist_center">
				...
				<div class="regist_main center">
					...
					<!-- <div class="username">地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;址:&nbsp;&nbsp;<input class="shurukuang" type="text" name="tel" placeholder="请输入您的地址"/><span>填写下地址吧，方便我们送货！</span></div> -->
					<table class="username" width="40%" border="0" cellspacing="0"
						cellpadding="0">
						<tr>
							<td>省：</td>
					...
					<textarea style="width: 300px" rows="5" cols="20" name="addr" id="addr"></textarea>
					<div class="clear"></div>
				</div>
