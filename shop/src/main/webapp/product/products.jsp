...
<div class="admin-biaogelist">
    <div class="listbiaoti am-cf">
      ...
      <dl>
        <button type="button" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus"onclick="location.href='insert.jsp'">添加商品</button>
      </dl>
      <form action="findByKeywords.do" method="post" class="am-btn am-btn-xs" style="margin-top:8px">
     	<input type="text" name="keywords">
      	<input type="submit" class="am-btn-success" value="搜索">
      </form>
                 ...
                 <td>${p.descr }</td>
                  <td>${p.normalprice }</td>
                   <td>${p.memberprice }</td>
                    ...
                    <td><img src="<%=path %>${p.imgPath }" width="80px" height="60px" /></td>
                    <td>
                    	<div class="am-btn-toolbar">
		                    ...
		                    <a href="javascript:void(0);" id="confirm_delete${p.id }" class="am-btn am-btn-default am-btn-xs am-text-danger am-round" title="删除商品"><span class="am-icon-trash-o" ></span></a>
		                    <script type="text/javascript">
								$(document).ready(function(){
									$("#confirm_delete"+${p.id }).click(function(){
										if(confirm("你确定要删除吗？")){
											$(location).attr('href',"delete.do?id="+${p.id});
										}
									});
								});
						   </script>	
