...
<div class=" admin-content">
		<div class="daohang">
			<ul>
				...
				<li><button type="button" class="am-btn am-btn-default am-radius am-btn-xs">管理员管理<a href="javascript: void(0)" class="am-close am-close-spin" data-am-modal-close="">×</a></button></li>
				...
				<li><button type="button" class="am-btn am-btn-default am-radius am-btn-xs">类别管理<a href="javascript: void(0)" class="am-close am-close-spin" data-am-modal-close="">×</a></button></li>
...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      ...
      <dl class="am-icon-home" style="float: right;">当前位置： 首页 > <a href="#">XXX列表</a></dl>
