...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      <ul class="am-icon-users">添加管理员</ul>
      <!--这里打开的是新页面-->
    </div>
    ...
    <form class="am-form am-g" action="insert.do" method="post" onsubmit="return confirmPwd()">
    	<table border=0 width=80% height=300px cellspacing=0 cellpadding=0>
    	    <tr>
    			<th>管理员名称:</th>
    			<td><input type="text" name="aname"  style="width:30%;height:27px" align="center"></td>
    		</tr>
    		<tr>
    			<th>密码:</th>
    			<td><input  class="apwd" type="password" name="apwd" style="width:30%;height:27px" align="center"></td>
    			
    		</tr>
    		<tr>
    			<th>确认密码:</th>
    			<td><input class="confirmpwd" type="password" name="apwd" style="width:30%;height:27px" align="center"></td>
    		</tr>
    		<tr>
    			<th></th>
    			<td>
